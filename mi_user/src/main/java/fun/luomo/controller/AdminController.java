...
public class AdminController {
    ...
    public Result login(@RequestBody Admin admin) {
        ...
        if (adminLogin == null) {
            return new Result(true, 0, StatusCode.ERROR, "登录失败");
        }
    ...
    public Result findAll() {
        return new Result(true, 0, StatusCode.OK, "查询成功", adminService.findAll());
    }
    ...
    public Result findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        ...
        return new Result(true, 0, StatusCode.OK, "查询成功", new PageResult<Admin>(pageList.getTotalElements(), pageList.getContent()));
    }
    ...
    public Result findSearch(@RequestBody Map searchMap) {
        return new Result(true, 0, StatusCode.OK, "查询成功", adminService.findSearch(searchMap));
    }
