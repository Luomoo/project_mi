...
import fun.luomo.service.OrderService;
...
public class OrderController {
	...
	public Result findAll(){
		return new Result(true,0,StatusCode.OK,"查询成功",orderService.findAll());
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(true,0,StatusCode.OK,"查询成功",orderService.findSearch(searchMap));
    }
